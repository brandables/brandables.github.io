 ...
 *
 * ------------------------------------------------------------------- */
emailjs.init("TBnRzpeEqL3uwrYut");
...
(function ($) {
  ...
  var cfg = {
      ...
      mailChimpURL:
        "https://gmail.us8.list-manage.com/subscribe/post?u=d75c5755ccab752c12c9f1fce&id=8a2f2ec6f5&f_id=000c10e0f0",
    },
    $WIN = $(window);
  ...
  var clContactForm = function () {
    ...
    $("#contactForm").on("submit", function (event) {
      ...
      emailjs.sendForm("service_hf6g0z7", "template_vozk1dc", this).then(
        function (response) {
